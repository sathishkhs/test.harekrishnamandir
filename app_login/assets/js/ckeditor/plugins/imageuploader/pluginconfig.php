...
$foldershistory[] = $useruploadfolder;
    ...
    $useruploadfolder = '/home/hkmaocez/harekrishnamandir.org/uploads/blog';
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = '/home/hkmaocez/harekrishnamandir.org/uploads/blog';
        

    $useruploadfolder = '/home/hkmaocez/harekrishnamandir.org';
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = '/home/hkmaocez/harekrishnamandir.org';
        

    $useruploadfolder = '/harekrishnamandir.org/uploads/blog';
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = '/harekrishnamandir.org/uploads/blog';
    ...
    $useruploadfolder = 'uploads/blog';
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = 'uploads/blog';
        

    $useruploadfolder = 'uploads/charitable_programs';
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = 'uploads/charitable_programs';
        

    $useruploadfolder = 'uploads/charitable_program';
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = 'uploads/charitable_program';
