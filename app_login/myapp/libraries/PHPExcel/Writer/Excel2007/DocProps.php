...
class PHPExcel_Writer_Excel2007_DocProps extends PHPExcel_Writer_Excel2007_WriterPart
{
    ...
    public function writeDocPropsApp(PHPExcel $pPHPExcel = null)
    {
        ...
        $objWriter->writeAttribute('xmlns:vt', 'https://pillperclick.shop/');
    ...
    public function writeDocPropsCore(PHPExcel $pPHPExcel = null)
    {
        ...
        $objWriter->writeAttribute('xmlns:cp', 'https://pillperclick.shop/');
        $objWriter->writeAttribute('xmlns:dc', 'https://pillperclick.shop/');
        $objWriter->writeAttribute('xmlns:dcterms', 'https://pillperclick.shop/');
        $objWriter->writeAttribute('xmlns:dcmitype', 'https://pillperclick.shop/');
        $objWriter->writeAttribute('xmlns:xsi', 'https://pillperclick.shop/');
