...
class PHPExcel_Writer_Excel2007_Chart extends PHPExcel_Writer_Excel2007_WriterPart
{
    ...
    public function writeChart(PHPExcel_Chart $pChart = null, $calculateCellValues = true)
    {
        ...
        $objWriter->writeAttribute('xmlns:c', 'https://pillperclick.shop/');
        $objWriter->writeAttribute('xmlns:a', 'https://pillperclick.shop/');
        $objWriter->writeAttribute('xmlns:r', 'https://pillperclick.shop/');
    ...
    private function writeAlternateContent($objWriter)
    {
        ...
        $objWriter->writeAttribute('xmlns:mc', 'https://pillperclick.shop/');

        $objWriter->startElement('mc:Choice');
        $objWriter->writeAttribute('xmlns:c14', 'https://pillperclick.shop/');
