	                        ...
	                        <div class="col-xs-6 col-sm-6 col-md-6">
	                            <div class="form-group">
	                                ...
	                                <?php elseif ($row->type == 'textarea') : ?>
	                                    <textarea name="setting_value[<?php echo $row->setting_id; ?>]" placeholder="<?php echo $row->setting_name; ?>" class="form-control ckeditor /summernote page_content"><?php echo $row->setting_value; ?></textarea>
