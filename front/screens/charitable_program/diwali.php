                ...
                <div class="container pt-1">
                  <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                      ...
                      <p>Participate in the festivities by offering various Sevas</p>
                      ...
                      <form id="popup_paypal_donate_form_onetime_recurring" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <?php } ?>
                        <input type="hidden" name="donation_type" value="<?php if ($payment_type == 0) {
                                                                            echo 'Charitable Programs';
                                                                          } elseif ($payment_type == 1) {
                                                                            echo 'Nitya Sevas';
                                                                          }else{ echo 'festival';}; ; ?>">
                        <input id="seva_name" name="seva_name" type="hidden" value="">
                        <input type="hidden" name="slug" value="<?php echo $page_items->page_slug; ?>">
                        <input type="hidden" name="festival" value="diwali">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-12 d-flex   p-0 border-0 mb-2 row">
                            <div class="form-check  col-md-6 mt-2">
                              <input class="form-check-input ml-10" type="radio" checked id="one" name="radioamount" data-seva="feed-50-people" value="751">
                              <label class="form-check-label pl-10" for="one"> ₹ 751 - Feed 50 people </label> &nbsp;
                            </div>

                            <div class="form-check col-md-6 mt-1">
                              <input class="form-check-input ml-10" type="radio" id="two" name="radioamount" data-seva="feed-100-people" value="1501">
                              <label class="form-check-label pl-10" for="two"> ₹ 1501 - Feed 100 people </label> &nbsp;
                            </div>

                            <div class="form-check  col-md-6 mt-1">
                              <input class="form-check-input ml-10" type="radio" id="three" name="radioamount" data-seva="feed-full-meal-100-people" value="3501">
                              <label class="form-check-label pl-10" for="three">₹ 3501 - Full meal for 100 people</label> &nbsp;
                            </div>

                            <div class="form-check  col-md-6 mt-1">
                              <input class="form-check-input ml-10" type="radio" id="five" name="radioamount" data-seva="feed-full-meal-200-people" value="7001">
                              <label class="form-check-label pl-10" for="five">₹ 7001 - Full meal for 200 people</label> &nbsp;
                            </div>


                            <div class="form-check  col-md-6 mt-1">
                              <input class="form-check-input ml-10" type="radio" id="seven" name="radioamount" data-seva="sponsor-1-day-khichadi-prasadam" value="11001">
                              <label class="form-check-label pl-10" for="seven">₹ 11001- 1day Khichadi Prasadam </label> &nbsp;
                            </div>

                            <div class="form-check  col-md-6 mt-1">
                              <input class="form-check-input ml-10" type="radio" id="eight" name="radioamount" data-seva="feed-4-cows-for-a-day" value="1501">
                              <label class="form-check-label pl-10" for="eight">₹ 1501 - Feed 4 Cows a Day </label> 
                            </div>

                            <div class="form-check  col-md-6 mt-1">
                              <input class="form-check-input ml-10" type="radio" id="nine" name="radioamount" data-seva="medicines-for-cow" value="1101">
                              <label class="form-check-label pl-10" for="nine">₹ 1101 - Medicines for Cow </label> &nbsp;
                            </div>
                            <div class="form-check  col-md-6 mt-1">
                              <input class="form-check-input ml-10" type="radio" id="ten" name="radioamount" data-seva="feed-2-cows-for-week" value="2101">
                              <label class="form-check-label pl-10" for="ten">₹ 2101 - Feed 2 Cows for a Week </label> &nbsp;
                            </div>
                            <div class="form-check  col-md-6 mt-1">
                              <input class="form-check-input ml-10" type="radio" id="eleven" name="radioamount" data-seva="feed-a-cow-a-month" value="5101">
                              <label class="form-check-label pl-10" for="eleven">₹ 5101 - Feed A Cow for a Month </label> &nbsp;
                            </div>
                            <div class="form-check  col-md-12 mt-1">
                              <input class="form-check-input ml-10" type="radio" id="twelve" name="radioamount" data-seva="green-grass-all-cows-day" value="10001">
                              <label class="form-check-label pl-10" for="twelve">₹ 10001 - Green Grass for All Cows for a Day </label> &nbsp;
                            </div>
                            <div class="form-check  col-md-6 mt-1">
                              <input class="form-check-input ml-10" type="radio" id="thirteen" name="radioamount" data-seva="vishesh-alankar" value="11000">
                              <label class="form-check-label pl-10" for="thirteen">₹ 11000 - Vishesh Alankar </label> &nbsp;
                            </div>
                            <div class="form-check  col-md-6 mt-1">
                              <input class="form-check-input ml-10" type="radio" id="fourteen" name="radioamount" data-seva="rajbhog-seva" value="11000">
                              <label class="form-check-label pl-10" for="fourteen">₹ 11000 - Rajbhog Seva </label> &nbsp;
                            </div>
                            <div class="form-check  col-md-6 mt-1">
                              <input class="form-check-input ml-10" type="radio" id="fifteen" name="radioamount" data-seva="pushpalankar" value="5001">
                              <label class="form-check-label pl-10" for="fifteen">₹ 5001 - Pushpalankar </label> &nbsp;
                            </div>
                            <div class="col-12 "><h6>&nbsp;Deep Daan Seva</h6></div>
                            <div class="form-check  col-md-6 mt-1">
                              <input class="form-check-input ml-10" type="radio" id="sixteen" name="radioamount" data-seva="deep-daan-1-day" value="1500">
                              <label class="form-check-label pl-10" for="sixteen">₹ 1500 - For 1 day </label> &nbsp;
                            </div>
                            <div class="form-check  col-md-6 mt-1">
                              <input class="form-check-input ml-10" type="radio" id="seventeen" name="radioamount" data-seva="deep-daan-3-day" value="3000">
                              <label class="form-check-label pl-10" for="seventeen">₹ 3000 - For 3 days </label> &nbsp;
                            </div>
                            <div class="form-check  col-md-6 mt-1">
                              <input class="form-check-input ml-10" type="radio" id="eighteen" name="radioamount" data-seva="deep-daan-1-week" value="10500">
                              <label class="form-check-label pl-10" for="eighteen">₹ 10500 - For 1 week </label> &nbsp;
                            </div>
                            <div class="form-check  col-md-6 mt-1">
                              <input class="form-check-input ml-10" type="radio" id="ninteen" name="radioamount" data-seva="deep-daan-2-weeks" value="21000">
                              <label class="form-check-label pl-10" for="ninteen">₹ 21000 - For 2 weeks </label> &nbsp;
                            </div>
