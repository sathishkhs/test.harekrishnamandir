...
<div class="container-fluid">
			...
			<figure class="hero-wrapper">
			  <div class="video-hero-wrapper">
			    <div class="overflow-wrapper">
			      <iframe src="https://www.youtube.com/embed/fawD0Z1tzYU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
			    </div>
				</div>
			</figure>
		</section>
  ...
  <div class="row">
    <div class="col-sm-12 text-center">
     <h2> Offer Janmashtami Seva & Receive Prasada </h2>
    </div>
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-12 d-flex   p-0 border-0 mb-2 row">
                            <div class="form-check  col-md-3 mt-2">
                              <input class="form-check-input ml-10" type="radio" checked id="one" name="radioamount" data-seva="janmashtami-receive-prasada" value="1111">
                              <label class="form-check-label pl-10" for="one"> ₹ 1111  </label> &nbsp;
                            </div>
                          
                            <div class="form-check col-md-3 mt-2">
                              <input class="form-check-input ml-10" type="radio" id="two" name="radioamount" data-seva="janmashtami-receive-prasada" value="2501">
                              <label class="form-check-label pl-10" for="two"> ₹ 2501  </label> &nbsp;
                            </div>
                         
                            <div class="form-check  col-md-3 mt-2">
                              <input class="form-check-input ml-10" type="radio" id="three" name="radioamount" data-seva="janmashtami-receive-prasada" value="5000">
                              <label class="form-check-label pl-10" for="three">₹ 5001 </label> &nbsp;
                            </div>
                    ...
                    <input name="address" type="hidden" value="NULL">
                      ...
                      <input name="pincode" type="hidden" value="NULL">
                        ...
                        <!-- <div class="row">
                          ...
                          <div class="form-group col-md-6">
                            <label>Pincode</label>
                            <input id="pincode" type="text" name="pincode" value="" class="form-control">
                          </div>
                        </div> -->
    ...
    $(document).ready(function() {
      ...
      $("#popup_paypal_donate_form_onetime_recurring").validate({
        ...
        submitHandler: function(form) {
          if ($('#amount').val() < 1111) {
            alert('Minimum Donation is ₹1111')
          } else {
            $.ajax({
              type: 'POST',
