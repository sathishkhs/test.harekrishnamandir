...
<section data-tm-bg-color="#f5f5f4">
  <div class="container pt-0 pt-lg-20 pb-10">
      ...
      <div class="col-lg-4">
            <div class="tm-sc-project-items project-items-current-theme-style1 text-center pb-md-30">
              <div class="project-item">
                <div class="thumb">
                <a href="the-guru"><img class="border-rounded" width="250px" height="250px" src="assets/images/about/srilaprabhu.jpg" alt="Image"></a>
                </div>
                <div class="content">
        ...
        <?php foreach ($gallery as $row) { ?>
          <div class="col-lg-4">
            <div class="tm-sc-project-items project-items-current-theme-style1 text-center pb-md-30">
              <div class="project-item">
                <div class="thumb">
                <a href="<?php echo 'gallery/show_gallery/'.$row->category_id; ?>"><img class="border-rounded" width="250px" height="250px" src="<?php echo GALLERY_IMG_UPLOAD_PATH . $row->gallery_img; ?>" alt="Image"></a>
                </div>
                <div class="content">
...
<section class="container-fluid" style="background-color: #fff !important; margin-top: -140px">
  ...
  display: none;
            ...
            <style>
              ...
              ?>
                <div class="upcoming-events-current-style bg-white " data-tm-margin-bottom="20" style="margin-bottom: 20px;margin-left: 0px">
                  ...
                  <div class="thumb"> 
                  <a href="<?php echo !empty($event->event_redirection_link) ? $event->event_redirection_link : base_url() . 'index/event/' . $event->event_id; ?>"><img src="<?php echo EVENT_COVER_IMAGE_UPLOAD_PATH.$event->event_cover_image; ?>" alt="Image" width="100px" height="100px!important"></a>
                  </div>
        ...
        <style>
          ...
          #mobile-event-scroll .slick-prev::before,#mobile-event-scroll .slick-next::before{
          ...
          #mobile-event-scroll .slick-next::before{
            content: '\f35a';
          }
          #mobile-event-scroll .slick-prev::before{
            content: '\f359';
          }
          
          </style>

        <div id="mobile-event-scroll">
        <?php foreach ($events as $event) {

$start_date = explode(' ', date('Y F d', strtotime($event->start_date)));
$end_date = explode(' ', date('Y F d', strtotime($event->end_date)));
?>
        <div  class="upcoming-events-current-style bg-white scroll-event-hori" data-tm-margin-bottom="20" style="margin-bottom: 20px;margin-left: 0px">
                  ...
                  <div class="event-details">
                    <h5 class="event-title mb-0 mt-0 "><a href="<?php echo !empty($event->event_redirection_link) ? $event->event_redirection_link : base_url() . 'index/event/' . $event->event_id; ?>"><?php echo $event->event_name; ?></a></h5>
                    <div class="event-time line-height-1 mb-10"><i class="text-theme-colored1 far fa-clock"> </i>&nbsp; <?php echo $event->start_date ; ?></div>
                    <!-- <div class="event-location line-height-1 mb-10"><i class="text-theme-colored1 fas fa-map-marker-alt"></i> </div> -->
                  </div>
                </div>
                <?php } ?>
                <script type="text/javascript">
              $(document).ready(function(){
                $('#mobile-event-scroll').slick({
        ...
        <div class="col-lg-12">
          <div class="project-tab-style1">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
              ...
              <li class="nav-item" role="presentation">
                <a class="nav-link active" id="eco-system-tab" href="dham-yatra" role="tab" aria-controls="eco-system" aria-selected="false"><img src="assets/images/icons/Gita Life Course.png" alt="Image"> <br>Dham Yatra</a>
              </li>
              <!-- <li class="nav-item" role="presentation">
                ...
                <div class="blog-current-theme-style3">
                    <article class="post">
                      ...
                      <div class="entry-content bg-white p-2">
                        ...
                        <h6 class="entry-title mt-0 mb-0">
