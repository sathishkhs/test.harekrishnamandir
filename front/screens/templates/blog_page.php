...
<meta property="og:url" content="<?php echo base_url().$page_items->page_slug; ?>" />
<meta property="og:description" content="<?php echo $page_items->meta_description; ?>">
<meta property="og:image" itemprop="image" content="<?php echo base_url().BLOG_PHOTO_UPLOAD_PATH.$post->post_image; ?>"/>
