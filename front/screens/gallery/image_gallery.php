              ...
              <div >
                <div class="container ">
                  ...
                  <div class="col-sm-12 col-md-6 col-lg-4 my-4">
                    <div class="card ">
                    <a href="<?php echo 'gallery/show_gallery/'.$gallery->category_id; ?>"><img src="<?php echo GALLERY_IMG_UPLOAD_PATH . $gallery->gallery_img; ?>" class="product-main-image img-responsive img-fullwidth" width="300" height="300" alt="<?php echo $gallery->category_name; ?>" style="object-fit: cover;"></a>
                      <div class="card-body">
